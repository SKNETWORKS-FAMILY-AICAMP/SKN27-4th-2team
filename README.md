...
| 팀원 | 회고 |
|---|---|
| 문재경 | 프로젝트를 끝까지 함께하지 못하고 중간에 이탈하게 되어 팀원들에게 미안한 마음이 남습니다. 하지만 한편으로는 이번 경험이 프로젝트를 완성하기 위해 필요한 여러 부분을 직접 학습하고 구현해보는 자극이 되었다고 생각합니다. 특히 프로젝트 초반과 비교했을 때, 이제는 GitHub를 활용해 보다 적극적으로 협업할 수 있게 되었다는 점에서 파이널 프로젝트 전에 힘들지만 유의미한 시간이 되었을거라 생각합니다. 함께해준 팀원들에게 고맙고, 각자의 자리에서 좋은 결과가 있기를 바랍니다. 그럼, 아디다스. |
